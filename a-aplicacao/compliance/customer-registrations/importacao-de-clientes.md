...
| **name**              |                                                                                                                                                                                                                                               |
| alternative\_names    | Nomes alternativos. Separados por vírgula caso existam múltiplos.                                                                                                                                                                             |
...
| invited\_email        | Email da pessoa a convidar para preenchimento do questionário. Nota: o convite será enviado automaticamente caso o cliente tenha créditos suficientes.                                                                                        |
| corporate\_object     |                                                                                                                                                                                                                                               |
| foundation\_date      | <p>A data de fundação deve seguir um dos seguintes formatos:</p><ul><li>dd-mm-yyyy</li><li>dd/mm/yyyy</li><li>yyyy-mm-dd</li><li>yyyy/mm/dd</li></ul>                                                                                         |
| nace\_codes           | Códigos CAE. Separados por vírgula caso existam múltiplos.                                                                                                                                                                                    |
| country\_constitution | A aplicação da PEPData suporta qualquer valor [ISO 3166](https://en.wikipedia.org/wiki/ISO_3166), nome comum ou nome oficial de cada país.                                                                                                    |
| operations\_countries | Separados por vírgula caso existam múltiplos.                                                                                                                                                                                                 |
| is\_identified        | 0, no caso de não existir identificação.                                                                                                                                                                                                      |
| country\_address      | A aplicação da PEPData suporta qualquer valor [ISO 3166](https://en.wikipedia.org/wiki/ISO_3166), nome comum ou nome oficial de cada país.                                                                                                    |
...
| adverse\_media        | <p>Tipos de adverse media, no formato [old/new]﻿_[serious/light]<em>_</em>[allegations/﻿accusations/﻿convictions]. <br>Separados por vírgula caso existam múltiplos. <br>Exemplo: old_serious_<em>allegations, new_light</em>_convictions</p> |
...
| responsible\_email      | Email do utilizador que irá ficar responsável pelo questionário do cliente. Tem de ser um utilizador inserido na sua organização.                                                                                                             |
| invited\_email          | Email do utilizador a convidar. Nota: o convite será enviado automaticamente caso o cliente tenha créditos suficientes.                                                                                                                       |
| invitation\_language    | <p>Língua do convite.</p><p>Valores aceites:</p><ul><li>pt</li><li>en</li><li>es</li></ul><p>Valor predefinido: en </p>                                                                                                                       |
...
| country\_birth          | A aplicação da PEPData suporta qualquer valor [ISO 3166](https://en.wikipedia.org/wiki/ISO_3166), nome comum ou nome oficial de cada país.                                                                                                    |
...
| address\_city           |                                                                                                                                                                                                                                               |
| adverse\_media          | <p>Tipos de adverse media, no formato [old/new]﻿_[serious/light]<em>_</em>[allegations/﻿accusations/﻿convictions]. <br>Separados por vírgula caso existam múltiplos. <br>Exemplo: old_serious_<em>allegations, new_light</em>_convictions</p> |
| employee\_no            | Número de funcionário (apenas disponível para a importação de funcionários).                                                                                                                                                                  |
| professional\_group     | Grupo profissional (apenas disponível para a importação de funcionários).                                                                                                                                                                     |
| unit                    | Unidade (apenas disponível para a importação de funcionários).                                                                                                                                                                                |
| department\_service     | Departamento/Serviço (apenas disponível para a importação de funcionários).                                                                                                                                                                   |
| reviewer\_line\_manager | Revisor/Chefia direta (apenas disponível para a importação de funcionários).                                                                                                                                                                  |
