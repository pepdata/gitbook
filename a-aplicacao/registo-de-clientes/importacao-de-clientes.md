...
| **position\_in\_organization** | Pode ter texto livre (ex: "Presidente", "Gerente", etc.) ou "owner", no caso da relação ser enquanto acionista ou detentor de direitos de voto. Caso o vat\_number seja de uma organização, este campo deve ter obrigatoriamente o valor "owner". |
