...
| invitation\_language  | <p>Idioma de la invitación.<br>Valores aceptados:<br>- pt<br>- en<br>- es<br>Valor predeterminado: en</p>                                                                                                                            |
| corporate\_object     |                                                                                                                                                                                                                                      |
...
| employee\_no            | Número de empleado (Disponible sólo para importar empleados).                                                                                                                                                                         |
| professional\_group     | Grupo profesional (Disponible sólo para importar empleados).                                                                                                                                                                          |
| unit                    | Unidade (Disponible sólo para importar empleados).                                                                                                                                                                                    |
| department\_service     | Departamento/Servicio (Disponible sólo para importar empleados).                                                                                                                                                                      |
| reviewer\_line\_manager | Revisor/Supervisor directo (Disponible sólo para importar empleados).                                                                                                                                                                 |
