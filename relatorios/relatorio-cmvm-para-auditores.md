...
{% hint style="warning" %}
O Relatório CMVM já se encontra disponível para aquisição. Consulte a página Relatório CMVM 2020.
{% endhint %}
...
3. Elaborar e efetuar o carregamento de 3 ficheiros, cada um com as seguintes propriedades:
   ...
   2. **Clientes \(Pessoas coletivas\)** 
      ...
      2. NIPC da empresa 
      3. Novo cliente: coloque **1** caso o cliente tenha sido angariado em 2020 ou **0** caso contrário
